<a name="0.4.0"></a>
# [0.4.0](https://github.com/ngrx/router/compare/v0.3.0...v0.4.0) (2016-05-03)
...
* **LinkActive:** Fix active link for base url when using hash ([#74](https://github.com/ngrx/router/issues/74))([12961d4](https://github.com/ngrx/router/commit/12961d4)), closes [(#74](https://github.com/(/issues/74)
